        ...
        s = (a) => {
            a.forEach((m) => {
                m.includes('Uint') && (e[m.replace('Uint', 'UInt')] = e[m]),
                    m.includes('Float64') &&
                        (e[m.replace('Float64', 'Double')] = e[m]),
                    m.includes('Float32') &&
                        (e[m.replace('Float32', 'Float')] = e[m])
            })
        }
    n.forEach((a, m) => {
        a.startsWith('read') &&
    ...
    u = we(() => {
        ...
        h = class e extends Uint8Array {
            ...
            indexOf(t, r = null, n = 'utf-8', i = !1) {
                let o = i
                    ? this.findLastIndex.bind(this)
                    : this.findIndex.bind(this)
            ...
            toString(t = 'utf8', r = 0, n = this.length) {
                if (
                    ...
                    return ''
                if (t === 'utf8' || t === 'utf-8')
                    return Jl.decode(this.slice(r, n))
                if (t === 'base64' || t === 'base64url') {
...
function be(e) {
    ...
    if (i > 0) {
        for (o += s, t = 1; t < i; t++)
            (n = e[t] + ''), (r = V - n.length), r && (o += Me(r)), (o += n)
        ;(s = e[t]), (n = s + ''), (r = V - n.length), r && (o += Me(r))
...
function io(e, t) {
    ...
    for (
        ...
        if (
            ...
            (r = r.times(++m)),
            (s = o.plus(Ie(i, r, a))),
            be(s.d).slice(0, a) === be(o.d).slice(0, a))
        ) {
...
function Nt(e, t) {
    ...
    if (
        ...
        for (; (n < 7 && n != 1) || (n == 1 && r.charAt(1) > 3); )
            (S = S.times(e)), (r = be(S.d)), (n = r.charAt(0)), A++
        ;(o = G(S)),
            n > 1
                ? ((S = new R('0.' + r)), o++)
                : (S = new R(n + '.' + r.slice(1)))
    ...
    for (
        a = s = S = Ie(S.minus(ue), S.plus(ue), f), T = _(S.times(S), f), i = 3;
        ;

    ) {
        if (
            ((s = _(s.times(T), f)),
            (m = a.plus(Ie(s, new R(i), f))),
            be(m.d).slice(0, f) === be(a.d).slice(0, f))
        )
            return (
                (a = a.times(2)),
...
function _(e, t, r) {
    ...
    if (((n = t - s), n < 0)) (n += V), (i = t), (f = A[(T = 0)])
    else {
        if (((T = Math.ceil((n + 1) / V)), (o = A.length), T >= o)) return e
...
function oo(e, t) {
    ...
    if (
        ...
        for (
            i = m.length, a = A.length, T = i < a, T && (a = i), i = 0;
            i < a;
            i++
        )
            if (m[i] != A[i]) {
...
var ot,
    ...
    uo = we(() => {
        ...
        v.dividedToIntegerBy = v.idiv = function (e) {
            var t = this,
                r = t.constructor
            return _(Ie(t, new r(e), 0, 1), r.precision)
        }
        ...
        v.logarithm = v.log = function (e) {
            ...
            else if (((e = new n(e)), e.s < 1 || e.eq(ue)))
                throw Error(ce + 'NaN')
            if (r.s < 1) throw Error(ce + (r.s ? 'NaN' : '-Infinity'))
            return r.eq(ue)
                ? new n(0)
                : ((B = !1), (t = Ie(Nt(r, o), Nt(e, o), o)), (B = !0), _(t, i))
        }
        v.minus = v.sub = function (e) {
            var t = this
            return (
                (e = new t.constructor(e)),
                t.s == e.s ? oo(t, e) : no(t, ((e.s = -e.s), e))
            )
        }
        ...
        v.squareRoot = v.sqrt = function () {
            ...
            for (
                ...
                if (
                    ((o = n),
                    (n = o.plus(Ie(a, o, s + 2)).times(0.5)),
                    be(o.d).slice(0, s) === (t = be(n.d)).slice(0, s))
                ) {
        ...
        v.toDecimalPlaces = v.todp = function (e, t) {
            ...
            return (
                ...
                e === void 0
                    ? r
                    : (xe(e, 0, ot),
                      t === void 0 ? (t = n.rounding) : xe(t, 0, 8),
                      _(r, e + G(r) + 1, t))
            )
        }
        ...
        v.toPower = v.pow = function (e) {
            ...
            if (((t = e.e), (r = e.d.length - 1), (s = t >= r), (o = a.s), s)) {
                if ((r = T < 0 ? -T : T) <= ro) {
                    for (
                        i = new m(ue), t = Math.ceil(n / V + 4), B = !1;
                        r % 2 && ((i = i.times(a)), to(i.d, t)),
                            (r = st(r / 2)),
                            r !== 0;
        ...
        v.toPrecision = function (e, t) {
            ...
            return (
                e === void 0
                    ? ((r = G(i)),
                      (n = Ge(i, r <= o.toExpNeg || r >= o.toExpPos)))
                    : (xe(e, 1, ot),
                      t === void 0 ? (t = o.rounding) : xe(t, 0, 8),
                      (i = _(new o(i), e, t)),
                      (r = G(i)),
        ...
        Ie = (function () {
            ...
            return function (n, i, o, s) {
                ...
                return N[0] || N.shift(), (S.e = m), _(S, s ? o + G(S) + 1 : o)
            }
        })()
        ao = so(zl)
        ue = new ao(1)
        ...
        ;(_t = class {
            ...
            async digest() {
                let t = new Uint8Array(
                        this.#e.reduce((i, o) => i + o.length, 0)
                    ),
                    r = 0
...
var Oo = ae((Sr) => {
    ...
    Sr.enginesVersion = ko().prisma.enginesVersion
})
var Lo = ae((Zy, Mo) => {
    'use strict'
    u()
...
var Jn = ae((yb, Uo) => {
    ...
    Uo.exports = (function () {
        ...
        return function (t, r) {
            ...
            for (; a < o; )
                for (
                    I = r.charCodeAt(s + (f = a)), S = ++a, m = 0;
                    m < je;
                    m += 2
                )
                    (N = oe[m]), (oe[m] = S = e(N, f, S, I, oe[m + 1])), (f = N)
            return S
        }
    })()
})
...
var Oa = ae((O) => {
    ...
    var pa = (e, t) => (BigInt(e >>> 0) << di) | BigInt(t >>> 0)
    O.toBig = pa
    var da = (e, t, r) => e >>> r
    O.shrSH = da
    var ma = (e, t, r) => (e << (32 - r)) | (t >>> r)
    O.shrSL = ma
    var fa = (e, t, r) => (e >>> r) | (t << (32 - r))
    O.rotrSH = fa
    var ga = (e, t, r) => (e << (32 - r)) | (t >>> r)
    O.rotrSL = ga
    var ya = (e, t, r) => (e << (64 - r)) | (t >>> (r - 32))
    O.rotrBH = ya
    var ha = (e, t, r) => (e >>> (r - 32)) | (t << (64 - r))
    O.rotrBL = ha
    var wa = (e, t) => t
    O.rotr32H = wa
    var ba = (e, t) => e
    O.rotr32L = ba
    var xa = (e, t, r) => (e << r) | (t >>> (32 - r))
    O.rotlSH = xa
    var Ea = (e, t, r) => (t << r) | (e >>> (32 - r))
    O.rotlSL = Ea
    var Pa = (e, t, r) => (t << (r - 32)) | (e >>> (64 - r))
    O.rotlBH = Pa
    var Ta = (e, t, r) => (e << (r - 32)) | (t >>> (64 - r))
    O.rotlBL = Ta
    function Aa(e, t, r, n) {
        let i = (t >>> 0) + (n >>> 0)
        return { h: (e + r + ((i / 2 ** 32) | 0)) | 0, l: i | 0 }
    }
    var Sa = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0)
    O.add3L = Sa
    var va = (e, t, r, n) => (t + r + n + ((e / 2 ** 32) | 0)) | 0
    O.add3H = va
    var Ca = (e, t, r, n) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0)
    O.add4L = Ca
    var Ra = (e, t, r, n, i) => (t + r + n + i + ((e / 2 ** 32) | 0)) | 0
    O.add4H = Ra
    var Ia = (e, t, r, n, i) =>
        (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (i >>> 0)
    O.add5L = Ia
    var ka = (e, t, r, n, i, o) => (t + r + n + i + o + ((e / 2 ** 32) | 0)) | 0
    O.add5H = ka
    var Jp = {
        fromBig: mi,
        split: ca,
...
var La = ae((M) => {
    ...
    M.concatBytes = id
    M.checkOpts = od
    M.wrapConstructor = sd
    M.wrapConstructorWithOpts = ad
    M.wrapXOFConstructorWithOpts = ud
    M.randomBytes = ld
    var At = Na(),
        gi = pi()
    function Hp(e) {
    ...
    M.byteSwapIfBE = M.isLE ? (e) => e : (e) => yi(e)
    function Yp(e) {
        for (let t = 0; t < e.length; t++) e[t] = yi(e[t])
    }
    var Xp = Array.from({ length: 256 }, (e, t) =>
        t.toString(16).padStart(2, '0')
    )
    function ed(e) {
        ;(0, gi.abytes)(e)
        let t = ''
        for (let r = 0; r < e.length; r++) t += Xp[e[r]]
        return t
    }
    ...
    function td(e) {
        ...
        for (let i = 0, o = 0; i < r; i++, o += 2) {
            let s = Da(e.charCodeAt(o)),
                a = Da(e.charCodeAt(o + 1))
    ...
    function rn(e) {
        return typeof e == 'string' && (e = Ma(e)), (0, gi.abytes)(e), e
    }
    function id(...e) {
        let t = 0
...
var ja = ae((q) => {
    ...
    for (let e = 0, t = tr, r = 1, n = 0; e < 24; e++) {
        ...
        for (let o = 0; o < 7; o++)
            (t = ((t << tr) ^ ((t >> dd) * fd)) % md),
                t & pd && (i ^= tr << ((tr << BigInt(o)) - tr))
        Ua.push(i)
    }
    var [gd, yd] = (0, rr.split)(Ua, !0),
        _a = (e, t, r) =>
    ...
    var nr = class e extends Ne.Hash {
        constructor(t, r, n, i = !1, o = 24) {
            ...
            ;(this.state = new Uint8Array(200)),
                (this.state32 = (0, Ne.u32)(this.state))
        }
        keccak() {
            Ne.isLE || (0, Ne.byteSwap32)(this.state32),
    ...
    q.Keccak = nr
    var Ue = (e, t, r) => (0, Ne.wrapConstructor)(() => new nr(t, e, r))
    q.sha3_224 = Ue(6, 144, 224 / 8)
    q.sha3_256 = Ue(6, 136, 256 / 8)
    q.sha3_384 = Ue(6, 104, 384 / 8)
    q.sha3_512 = Ue(6, 72, 512 / 8)
    q.keccak_224 = Ue(1, 144, 224 / 8)
    q.keccak_256 = Ue(1, 136, 256 / 8)
    q.keccak_384 = Ue(1, 104, 384 / 8)
    q.keccak_512 = Ue(1, 72, 512 / 8)
    var Ba = (e, t, r) =>
        (0, Ne.wrapXOFConstructorWithOpts)(
            (n = {}) => new nr(t, e, n.dkLen === void 0 ? r : n.dkLen, !0)
        )
    q.shake128 = Ba(31, 168, 128 / 8)
    q.shake256 = Ba(31, 136, 256 / 8)
})
var Za = ae((Jk, qe) => {
    'use strict'
    u()
    ...
    var Ga = (e = '') => Ha(hd(e)).toString(36).slice(1),
        Qa = Array.from({ length: 26 }, (e, t) => String.fromCharCode(t + 97)),
        wd = (e) => Qa[Math.floor(e() * Qa.length)],
        Wa = ({
            ...
            return Ga(n).substring(0, ir)
        },
        za = (e) => () => e++,
        bd = 476782367,
        Ka = ({
            random: e = Math.random,
            counter: t = za(Math.floor(e() * bd)),
            length: r = Ja,
            fingerprint: n = Wa({ random: e })
        } = {}) =>
            function () {
                let o = wd(e),
                    ...
                    m = hi(r, e),
                    f = `${s + m + a + n}`
                return `${o + Ga(f).substring(1, r)}`
            },
        xd = Ka(),
        Ed = (e, { minLength: t = 2, maxLength: r = ir } = {}) => {
            let n = e.length,
                i = /^[0-9a-z]+$/
            try {
    ...
    qe.exports.getConstants = () => ({ defaultLength: Ja, bigLength: ir })
    qe.exports.init = Ka
    qe.exports.createId = xd
    qe.exports.bufToBigInt = Ha
    qe.exports.createCounter = za
    qe.exports.createFingerprint = Wa
    qe.exports.isCuid = Ed
})
var Ya = ae((Zk, or) => {
    'use strict'
    u()
    ...
    p()
    d()
    var { createId: Pd, init: Td, getConstants: Ad, isCuid: Sd } = Za()
    or.exports.createId = Pd
    or.exports.init = Td
    or.exports.getConstants = Ad
    or.exports.isCuid = Sd
})
var Xm = {}
it(Xm, {
    AnyNull: () => re.AnyNull,
...
d()
var Dn = {}
it(Dn, { defineExtension: () => lo, getExtensionContext: () => co })
u()
l()
c()
p()
...
var Fe = require('@prisma/client-runtime-utils')
u()
l()
c()
p()
...
var Yl = {
    enabled:
        !go && yo == null && ho !== 'dumb' && ((_n != null && _n !== '0') || wo)
}
function $(e, t) {
    ...
    let t = {
        ...
        r = (...n) => {
            ...
            if (
                ...
                Mt.length > Xl && Mt.shift(),
                Lt.enabled(o) || i)
            ) {
                let m = n.map((T) => (typeof T == 'string' ? T : rc(T))),
                    f = `+${Date.now() - So}ms`
                ;(So = Date.now()), a(o, ...m, f)
            }
        }
...
var te = new Proxy(tc, { get: (e, t) => Lt[t], set: (e, t, r) => (Lt[t] = r) })
function rc(e, t = 2) {
    let r = new Set()
...
function Un(e, ...t) {
    _o.warn() && console.warn(`${$t.warn} ${e}`, ...t)
}
function oc(e, ...t) {
...
d()
var Bt = {}
it(Bt, { ModelAction: () => qt, datamodelEnumToSchemaEnum: () => lc })
u()
l()
c()
p()
...
function mc({ message: e, originalMethod: t, isPanic: r, callArguments: n }) {
    return {
    ...
    if (
        (n
            ? (a.push(
              ...
              a.push(
                  s.red(
                      `It occurred in the ${s.bold(`\`${e}\``)} invocation${m}`
                  )
              ))
            : a.push(s.red(`Invalid ${s.bold(`\`${e}\``)} invocation${m}`)),
        t && a.push(s.underline(gc(t))),
        i)
    ) {
        a.push('')
        let f = [i.toString()]
        o && (f.push(o), f.push(s.dim(')'))),
            a.push(f.join('')),
            o && a.push('')
    ...
    for (let n of e) {
        ...
        o
            ? t.set(i, {
                  ...
                  argument: {
                      ...n.argument,
                      typeNames: hc(o.argument.typeNames, n.argument.typeNames)
                  }
              })
            : t.set(i, n)
    }
...
var Dr = (e) => e,
    ...
    Go = { bold: xr, red: at, green: bo, dim: Er, enabled: !0 },
    mt = {
        write(e) {
            e.writeLine(',')
        }
        ...
        if (e.dependentArgumentPath) {
            ...
            t.addErrorMessage(
                (f) =>
                    `Argument \`${f.green(
                        o
                    )}\` is required because argument \`${f.green(
                        m
                    )}\` was provided.`
            )
        }
...
function ns(e) {
    ...
    return e instanceof ts.ObjectEnumValue
        ? new K(`Prisma.${e._getName()}`)
        : ht(e)
        ? new K(`prisma.${Le(e.modelName)}.$fields.${e.name}`)
        : Array.isArray(e)
        ? Uc(e)
        : typeof e == 'object'
        ? rs(e)
...
function ss(e, t, r) {
    ...
    return !t.result || !(t.result.$allModels || t.result[n])
        ...
        : qc({
              ...e,
              ...os(t.name, e, t.result.$allModels),
              ...os(t.name, e, t.result[n])
          })
}
function qc(e) {
    let t = new Ee(),
...
function Br({
    ...
    return { modelName: e, action: jc[t], query: Gt(r, C) }
}
function Gt({ select: e, include: t, ...r } = {}, n) {
    let i = r.omit
    return delete r.omit, { arguments: fs(r, n), selection: Qc(e, t, i, n) }
}
function Qc(e, t, r, n) {
    return e
        ? (t
...
function ms(e, t) {
    ...
    if (e instanceof Fe.ObjectEnumValue) {
        if (
            !(0, Fe.isDbNull)(e) &&
            !(0, Fe.isJsonNull)(e) &&
            !(0, Fe.isAnyNull)(e)
...
var Wn = class e {
    ...
    getGlobalOmit() {
        return this.params.modelName && this.shouldApplyGlobalOmit()
            ? this.params.globalOmit?.[Le(this.params.modelName)] ?? {}
            : {}
    }
    shouldApplyGlobalOmit() {
        switch (this.params.action) {
            ...
            case 'queryRaw':
                return !1
            default:
                ke(this.params.action, 'Unknown action')
        }
    }
    nestArgument(t) {
        return new e({
...
function Et(e = {}) {
    ...
    return Object.entries(t).reduce(
        (n, [i, o]) => (
            Es[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n
        ),
        { select: {} }
    )
}
...
function Ts(e, t) {
    return t({ action: 'count', unpacker: np(e), argsMapper: rp })(e)
}
u()
l()
c()
...
function As(e, t) {
    return t({ action: 'groupBy', unpacker: op(e), argsMapper: ip })(e)
}
function Ss(e, t, r) {
...
var Cs = (e) => (Array.isArray(e) ? e : e.split('.')),
    Xn = (e, t) => Cs(t).reduce((r, n) => r && r[n], e),
    Rs = (e, t, r) =>
        Cs(t).reduceRight(
...
function pp(e, t) {
    ...
    return {
        ...
        getPropertyValue(i) {
            ...
            return lp.includes(o) ? ei(e, t, s) : dp(i) ? Ss(e, i, s) : s({})
        }
    }
}
function dp(e) {
...
function Ns({ result: e, modelName: t, select: r, omit: n, extensions: i }) {
    ...
    for (let m of Object.values(o)) {
        ...
        yp(e, m.needs) && s.push(hp(m, ge(e, s)))
    }
...
p()
d()
var wp = ['$connect', '$disconnect', '$on', '$transaction', '$extends'],
    Ls = wp
function _s(e) {
    if (e instanceof Ke.Sql) return bp(e)
    if (Qr(e)) return xp(e)
    if (Array.isArray(e)) {
        let r = [e[0]]
...
function Qs({ dataPath: e, modelName: t, args: r, runtimeDataModel: n }) {
    ...
    for (let m of o) {
        let f = n.models[s]
        if (!f) return i
        let T = f.fields.find((A) => A.name === m)
        if (!T)
            throw new Error(
...
function oi(e) {
    throw Kr(e)
        ? new Z(
              ...
              }\`. Message: \`${e.cause.originalMessage ?? Zs(e)}\``,
              'P2010',
...
function Zs(e) {
    switch (e.cause.kind) {
        ...
        case 'ForeignKeyConstraintViolation':
            return `Foreign key constraint violated on the ${ii(
                e.cause.constraint
            )}`
        case 'UnsupportedNativeDataType':
...
function Ys(e, t, r = {}) {
    let n = e.map((o) => t.keys.reduce((s, a) => ((s[a] = ye(o[a])), s), {})),
...
p()
d()
var ta = require('@prisma/client-runtime-utils')
...
function kp(e) {
    let t = Xs.get(e)
    return t || ((t = Object.entries(e)), Xs.set(e, t)), t
}
function ra(e, t, r) {
    switch (t.type) {
        case 'affectedRows':
...
function ai(e, t, r, n) {
    ...
    if (Array.isArray(e)) {
        let i = e
        return n && (i = i.filter((o) => o !== null)), i.map((o) => ea(o, t, r))
    }
    if (typeof e == 'object') return ea(e, t, r)
    if (typeof e == 'string') {
        let i
        try {
            i = JSON.parse(e)
    ...
    for (let [i, o] of kp(t))
        switch (o.type) {
            ...
            case 'field':
                {
                    let s = o.dbName
                    if (Object.hasOwn(e, s)) n[i] = Op(e[s], s, o.fieldType, r)
                    else
                        throw new U(
...
function si(e, t, r, n) {
    switch (r.type) {
        ...
        case 'datetime': {
            if (typeof e == 'string') return { $type: 'DateTime', value: Dp(e) }
            ...
            switch (r.encoding) {
                ...
                case 'array':
                    if (Array.isArray(e))
                        return {
                            $type: 'Bytes',
                            value: g.from(e).toString('base64')
                        }
                    if (e instanceof Uint8Array)
                        return {
                            $type: 'Bytes',
...
var Np = /\d{2}:\d{2}:\d{2}(?:\.\d+)?(Z|[+-]\d{2}(:?\d{2})?)?$/
function Dp(e) {
    let t = Np.exec(e)
...
function Ae(e) {
    ...
    if (n === '[object Object]') {
        if (e.constructor !== Object && typeof e.constructor == 'function') {
            r = new e.constructor()
            for (t in e)
                e.hasOwnProperty(t) && r[t] !== e[t] && (r[t] = Ae(e[t]))
        } else {
            r = {}
            for (t in e)
                t === '__proto__'
    ...
    if (n === '[object Array]') {
        for (t = e.length, r = Array(t); t--; ) r[t] = Ae(e[t])
        return r
    }
    return n === '[object Set]'
        ? ((r = new Set()),
...
p()
d()
var Xa = 'useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict'
var vd = 128,
    Xe,
    vt
function Cd(e) {
    !Xe || Xe.length < e
        ? ((Xe = g.allocUnsafe(e * vd)), Ft.getRandomValues(Xe), (vt = 0))
...
function wi(e = 21) {
    Cd((e |= 0))
    let t = ''
    for (let r = vt - e; r < vt; r++) t += Xa[Xe[r] & 63]
    return t
}
u()
l()
...
d()
We()
var tu = '0123456789ABCDEFGHJKMNPQRSTVWXYZ',
    sr = 32
var Rd = 16,
    ru = 10,
    eu = 0xffffffffffff
...
function Id(e) {
    ...
    return t === sr && (t = sr - 1), tu.charAt(t)
}
function kd(e) {
    let t = Od(),
...
function Dd(e, t = ru) {
    ...
    if (e > eu)
        throw new tt(
            ...
            `Cannot encode a time larger than ${eu}: ${e}`
        )
    if (e < 0)
        throw new tt(et.EncodeTimeNegative, `Time must be positive: ${e}`)
    if (Number.isInteger(e) === !1)
        throw new tt(
            et.EncodeTimeValueMalformed,
            `Time must be an integer: ${e}`
        )
    let r,
        n = ''
    for (let i = t; i > 0; i--)
        (r = e % sr), (n = tu.charAt(r) + n), (e = (e - r) / sr)
    return n
}
function Md() {
...
function _d(e, t, r) {
    let n
    if (e) n = iu(e.random ?? e.rng?.() ?? Ct(), e.msecs, e.seq, t, r)
    else {
        let i = Date.now(),
            o = Ct()
        Fd(Ei, i, o), (n = iu(o, Ei.msecs, Ei.seq, t, r))
    }
    return t ?? nn(n)
}
function Fd(e, t, r) {
...
function Vd(e, t) {
    ...
    return (
        ...
        t.reverse && e.reverse(),
        Object.keys(t.nested).length === 0 ? e : e.map((r) => au(r, t.nested))
    )
}
function Ud(e, t) {
    let r = new Set(),
...
function su(e, { cursor: t, skip: r, take: n }) {
...
function Di(e, t, r, n) {
    ...
    switch (e.type) {
        case 'rawSql':
            return [Qd(e.sql, i, e.argTypes)]
        case 'templateSql':
            return (e.chunkable ? Hd(e.fragments, i, n) : [i]).map((s) => {
                if (n !== void 0 && s.length > n)
                    throw new Z(
                        'The query parameter limit supported by your database is exceeded.',
                        'P2029'
                    )
                return Bd(e.fragments, e.placeholderFormat, s, e.argTypes)
            })
        default:
...
function Bd(e, t, r, n) {
    ...
    for (let m of Ni(e, r, n)) {
        if (((i += jd(m, t, o)), m.type === 'stringChunk')) continue
        let f = s.length,
            T = s.push(...uu(m)) - f
    ...
    switch (n) {
        ...
        case 'parameterTuple':
            return `(${
                e.value.length == 0
                    ? 'NULL'
                    : e.value.map(() => Oi(t, r.placeholderNumber++)).join(',')
            })`
...
function cu(e) {
    return {
        ...
        types: e.columnTypes.map((t) => Wd(t)),
...
var ur = class e {
    ...
    async interpretNode(t, r) {
        switch (t.type) {
            case 'value':
                return { value: de(t.args, r.scope, r.generators) }
            case 'seq': {
                let n
            ...
            case 'sum': {
                ...
                return {
                    value: n.length > 0 ? n.reduce((i, o) => Se(i) + Se(o)) : 0
                }
            }
            case 'execute': {
                let n = Di(t.args, r.scope, r.generators, this.#s()),
                    i = 0
                for (let o of n) {
                    let s = mu(o, r.sqlCommenter)
                    i += await this.#u(s, r.queryable, () =>
                        r.queryable
                            .executeRaw(s)
                            .catch((a) =>
                                t.args.type === 'rawSql' ? oi(a) : Tt(a)
                            )
                    )
                }
                return { value: i }
            ...
            case 'required': {
                ...
                if (du(n)) throw new Error('Required value is empty')
            ...
            case 'mapField': {
                ...
                return { value: fu(n, t.args.field), lastInsertId: i }
            }
            case 'join': {
                let { value: n, lastInsertId: i } = await this.interpretNode(
                    t.args.parent,
                ...
                return { value: Zd(n, o), lastInsertId: i }
            }
            case 'transaction': {
            ...
            case 'dataMap': {
                ...
                return {
                    value: ra(n, t.args.structure, t.args.enums),
                    lastInsertId: i
                }
            }
            case 'validate': {
                ...
                return (
                    pu(n, t.args.rules, t.args), { value: n, lastInsertId: i }
                )
            }
            case 'if': {
            ...
            case 'process': {
                ...
                return (
                    gu(t.args.operations, r.scope, r.generators),
                    { value: un(n, t.args.operations), lastInsertId: i }
                )
            }
            case 'initializeRecord': {
                ...
                for (let [o, s] of Object.entries(t.args.fields))
                    i[o] = Yd(s, n, r.scope, r.generators)
            ...
            case 'mapRecord': {
                ...
                for (let [s, a] of Object.entries(t.args.fields))
                    o[s] = Xd(a, o[s], r.scope, r.generators)
...
function mu(e, t) {
    ...
    let r = na(t.plugins, { query: t.queryInfo, sql: e.sql })
    return r ? { ...e, sql: ia(e.sql, r) } : e
}
function gu(e, t, r) {
    let n = e.pagination?.cursor
    if (n) for (let [i, o] of Object.entries(n)) n[i] = de(o, t, r)
    for (let i of Object.values(e.nested)) gu(i, t, r)
}
u()
l()
c()
...
var tm = 100,
    ...
    rm = () => ({ sql: 'COMMIT', args: [], argTypes: [] }),
    nm = () => ({ sql: 'ROLLBACK', args: [], argTypes: [] }),
    im = () => ({
    ...
    cr = class {
                    ...
                    if (n.signal.aborted)
                        throw (
                            (o
                                .then((s) => s.rollback())
                                .catch((s) =>
                                    kt('error in discarded transaction:', s)
                                ),
            ...
            let n = async () => {
                ...
                try {
                    ...
                    ;(t.status = r),
                        ...
                        this.closedTransactions.length > tm &&
        ...
        #a(t) {
            if (!t.timeout) throw new me('timeout is required')
            if (!t.maxWait) throw new me('maxWait is required')
...
function Tu(e) {
    if (Array.isArray(e)) return e.map((t) => Tu(t))
...
function um(e) {
    return Array.isArray(e)
        ? { scalarType: e.length > 0 ? Eu(e[0]) : 'unknown', arity: 'list' }
        : { scalarType: Eu(e), arity: 'scalar' }
}
function Eu(e) {
...
function Ru({
    ...
    return (0, Cu.default)({ user: t, repo: r, template: n, title: e, body: i })
}
function Iu({
    version: e,
    binaryTarget: t,
...
\`\`\``
            : '',
        T =
            lt(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
var wn = class {
    ...
    #i(t, r) {
        ...
        let o = `%${this.#n++}`
        return this.#r.set(n, o), this.#t.set(o, t), Nu(o, r)
    }
    ...
    #s(t, r) {
        ...
        if (!Ce(r, ve.ParamScalar)) return t
        let n = Be(r)
        if (n === 0) return t
        let i = Fi(t)
        return _u(i, n)
    ...
    #l(t, r, n) {
        if (!Ce(n, ve.ParamScalar)) return t
        let i = Be(n)
        if (i === 0 || !$u(r, i)) return t
        let o = Fu(t.$type),
            s = Vu(t)
        return this.#i(s, o)
    }
    #u(t, r, n) {
        if (Ce(n, ve.ParamScalar) && Be(n) & X.Json) {
            let i = JSON.stringify(ye(t)),
                o = { type: 'Json' }
            return this.#i(i, o)
        }
        if (Ce(n, ve.ParamEnum)) {
        ...
        if (Ce(n, ve.ListObject)) {
            let i = this.#e.inputNode(n.childNodeId)
            if (i) return t.map((o) => (ku(o) ? this.#o(o, i) : o))
        }
        return r
    }
    #p(t, r) {
        ...
        for (let [i, o] of Object.entries(t)) {
            ...
            if (s) {
                let a = o,
                    ...
                    T = {
                        selection: a.selection ? this.#c(a.selection, f) : {}
                    }
                a.arguments && (T.arguments = this.#o(a.arguments, m)),
                    (n[i] = T)
            } else n[i] = o
        }
        return n
...
function Lu(e) {
    return e.type === 'List' ? `List<${Lu(e.inner)}>` : e.type
}
function cm(e) {
...
function Uu(e, t, r) {
    ...
    if (n.expires) {
        if (!wm(n.expires) || Number.isNaN(n.expires.valueOf()))
...
var Hu = te('prisma:client:clientEngine:remoteExecutor'),
    An = class {
        #e
        #t
        #r
    ...
    Vi = class {
        ...
        async request({ method: t, path: r, headers: n, body: i, fetch: o }) {
            ...
            return (
                ...
                (this.#r =
                    m.headers.get('Accelerate-Query-Engine-Jwt') ?? void 0),
                this.#i(s, m),
                m
            )
        }
            ...
            return (
                e.activeProvider === void 0 || Ui[e.activeProvider] === void 0
                    ? ((n = (async () => {
                          ...
                          return (
                              i.__wbg_set_wasm(a.exports), m(), i.QueryCompiler
                          )
                      })()),
...
var Em = 'P2038',
    De = te('prisma:client:clientEngine'),
    Zu = globalThis
    ...
    constructor(t, r) {
        if (t.accelerateUrl !== void 0)
            ...
            (this.#n = { remote: !1, driverAdapterFactory: t.adapter }),
                De('Using driver adapter: %O', t.adapter)
        else
...
${n.backtrace}`,
    ...
    async transaction(t, r, n) {
        ...
        try {
            ...
            } else ke(t, 'Invalid transaction action.')
        } catch (s) {
            throw this.#c(s)
        }
    ...
    async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
        ...
        if (zu(t)) s = Ku(t)
            ...
            let { parameterizedQuery: m, placeholderValues: f } = Du(
                    t,
                    this.#o
                ),
                T = JSON.stringify(m)
            ...
            A
                ? (De('query plan cache hit'), (s = A))
                : (De('query plan cache miss'),
                  (s = this.#h(m, T, o)),
                  this.#i.setSingle(T, s))
        }
        try {
            De('query plan created', s)
            ...
            return De('query plan executed'), { data: { [t.action]: m } }
        } catch (m) {
            throw this.#c(m, JSON.stringify(t))
        }
    }
    async requestBatch(t, { transaction: r, customDataProxyFetch: n }) {
        ...
        if (T) A = this.#f(t, a, f)
            ...
            let { parameterizedBatch: S, placeholderValues: N } = Mu(
                    s,
                    this.#o
                ),
                R = JSON.stringify(S)
            ...
            if (I) De('batch query plan cache hit'), (A = I)
            else {
                De('batch query plan cache miss')
                try {
        ...
        try {
            ...
            switch ((r?.kind === 'itx' && (S = r.options), A.type)) {
                ...
                case 'compacted': {
                    ...
                    return Ys(N, A, C).map((I) => ({ data: { [i]: I } }))
                }
            }
        } catch (S) {
            throw this.#c(S, a)
...
var ji =
        ...
        (r) => {
            ...
            if (Qr(r))
                ...
                let [o, ...s] = r
                ;(n = o),
                    (i = { values: Ot(s || []), __prismaRawParameters__: !0 })
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
...
var Sm = pl.version.split('.')[0],
    vm = 'PRISMA_INSTRUMENTATION',
    Cm = `V${Sm}_PRISMA_INSTRUMENTATION`,
    dl = globalThis
function ml() {
    let e = dl[Cm]
    return e?.helper ? e.helper : dl[vm]?.helper
}
var Rm = {
        isEnabled() {
            return !1
...
function vn(e) {
    ...
    for (let n = 0; n < e.rows.length; n++) {
        ...
        for (let s = 0; s < i.length; s++)
            o[e.columns[s]] = nt(e.types[s], i[s])
        t.push(o)
    }
    return t
}
...
var Om = te('prisma:client:request_handler'),
    Cn = class {
        client
        dataloader
        logEmitter
                    ...
                    batchLoader: Us(
                        async ({ requests: n, customDataProxyFetch: i }) => {
                            let { transaction: o, otelParentCtx: s } = n[0],
                                ...
                                f = n.some((A) => Wi(A.protocolQuery.action))
                            return (
        ...
        handleRequestError({
            ...
            if ((Om(t), Dm(t, i))) throw t
            if (t instanceof D.PrismaClientKnownRequestError && Mm(t)) {
                let f = xl(t.meta)
                $r({
                    args: o,
                    errors: [f],
            ...
            if (
                ...
                if (t.isPanic)
                    throw new D.PrismaClientRustPanicError(
                        m,
...
Ut(j, 'PrismaClientConstructorValidationError')
var El = [
        'errorFormat',
        'adapter',
        'accelerateUrl',
    ...
    Lm = {
        ...
        omit: (e, t) => {
            ...
            if (r.length > 0) throw new j(Vm(e, r))
        },
        comments: (e) => {
            if (e !== void 0) {
                if (!Array.isArray(e))
...
function Al(e, t) {
    let r = Object.keys(e).find((n) => Le(n) === t)
    if (r) return e[r]
}
function Vm(e, t) {
    let r = wt(e)
...
function Ol(e) {
    class t {
        ...
        constructor(n) {
            ...
            ;(e = n.__internal?.configOverride?.(e) ?? e), vl(n, e)
...
function Il(e, t) {
    return jm(e) ? [new kl.Sql(e, t), ul] : [e, ll]
}
function jm(e) {
...
var Jm = () => globalThis.process?.release?.name === 'node',
    ...
    Gm = () => !!globalThis.Deno,
    Wm = () => typeof globalThis.Netlify == 'object',
    zm = () => typeof globalThis.EdgeRuntime == 'object',
...
var D = require('@prisma/client-runtime-utils'),
    ...
    re = require('@prisma/client-runtime-utils'),
    Ml = require('@prisma/client-runtime-utils')
0 &&
    (module.exports = {
        AnyNull,
        DMMF,
