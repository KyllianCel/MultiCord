...
declare interface AdapterInfo {
    ...
    readonly adapterName:
        | (typeof officialPrismaAdapters)[number]
        | (string & {})
}
...
declare type Client = ReturnType<typeof getPrismaClient> extends new (
...
> = (_1 extends unknown
    ? _2 extends unknown
        ? {
              ...
              operation: _2
              query: <
                  A extends DynamicQueryExtensionCbArgsArgs<TypeMap, _0, _1, _2>
              >(
                  args: A
